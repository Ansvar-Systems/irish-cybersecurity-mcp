...
[![npm version](https://badge.fury.io/js/%40ansvar%2Firish-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/irish-cybersecurity-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/irish-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add irish-cybersecurity-mcp --transport http https://mcp.ansvar.eu/irish-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "irish-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/irish-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/irish-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "irish-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/irish-cybersecurity-mcp"]
    }
  }
}
```
